...
#include <stdio.h>
#include <stdlib.h>
#include "IntQueue2.h"   //사용자 정의 큐 헤더파일
...
int main()
{
    ...
    while (1)
    {
        ...
        case 5:
        {
            ...
            int idx = Search(queue, search);     // 실제 배열 인덱스 반환
            int idx_2 = Search2(queue, search);  // front로부터의 상대적 위치 반환
